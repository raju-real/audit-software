                ...
                <div class="accordion-item">
                    ...
                    <div id="collapseSearch" class="accordion-collapse collapse {{ request()->query() ? 'show' : '' }}"
                        ...
                        <div class="accordion-body">
                            <form method="GET" action="{{ route('admin.supervisor-audits') }}">
                                <div class="row">
                                ...
                                @forelse($audits as $audit)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a data-bs-toggle="tooltip" data-bs-placement="top" title="Review Steps"
                                                href="{{ route('admin.supervisor-audit-steps', encrypt_decrypt($audit->id, 'encrypt')) }}"
                                                class="btn btn-sm btn-info"><i class="fa fa-tasks"></i></a>
                                            <a target="_blank" data-bs-toggle="tooltip" data-bs-placement="top"
                                                title="Balance Sheet"
                                                href="{{ route('admin.audit-wise-supervisor-balance-sheet', encrypt_decrypt($audit->id, 'encrypt')) }}"
