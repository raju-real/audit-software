                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <select name="workflow_status" class="form-select">
                                                <option value="" {{ !isset(request()->workflow_status) ? 'selected' : '' }}>Workflow Status</option>
                                                @foreach(getWorkFlowStatus() as $status)
                                                    <option
                                                        value="{{ $status->value }}" {{ request('workflow_status') === $status->value ? 'selected' : '' }}>{{ $status->title }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <select name="step_status" class="form-select">
                                                <option value="" {{ !isset(request()->step_status) ? 'selected' : '' }}>Step Status</option>
