                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            @if ($step->status !== 'draft')
                                                <a data-bs-toggle="tooltip" data-bs-placement="top" title="Start Review"
                                                    href="{{ route('admin.review-step-answer', encrypt_decrypt($step->id,'encrypt')) }} }}" class="btn btn-sm btn-info"><i class="fa fa-comments"></i></a>
                                            @else
                                                <span class="btn btn-sm btn-soft-warning" data-bs-toggle="tooltip"
                                                    data-bs-placement="top" title="Waiting for auditor submit.">
