...
class DesignationController extends Controller
{
    public function index()
    {
        ...
        return view('admin.staff.designation_list', compact('designations'));
    }

    public function create()
    {
        $route = route('admin.designations.store');
        return view('admin.staff.designation_add_edit', compact('route'));
    }
    ...
    public function edit($slug)
    {
        ...
        return view('admin.staff.designation_add_edit', compact('designation', 'route'));
    }
