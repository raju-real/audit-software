...
class StaffController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('admin.staff.staff_add_edit', compact('route', 'designations'));
    }
    ...
    public function edit($id)
    {
        ...
        $designations = Designation::orderBy('name')->get(['id', 'name']);
        return view('admin.staff.staff_add_edit', compact('staff', 'route','designations'));
    }
    ...
    {
        $staff = User::admin()->findOrFail($id);
