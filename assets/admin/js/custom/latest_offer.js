...
// Debounce to reduce excessive API calls
    ...
    function fetchProducts(query) {
        axios.get(`${base_url}/search-own-discount-products`, {params: {query: query}})
            .then(response => {
                ...
                <div class="list-group-item d-flex align-items-center justify-content-between" id="item_product_${product.id}">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <div class="text-muted">Unit Price: ${product.unit_price} || Discount Price: ${product.discount_price}</div>
                        </div>
                    </div>
    ...
    function addProductToSection(productId) {
        axios.post(`${base_url}/add-latest-offer-product`, {
    ...
    function loadProducts() {
        axios.get(`${base_url}/get-latest-offer-products`)
            .then(response => {
                    ...
                    products.forEach(product => {
                        ...
                        <tr data-id="${product.id}">
                            ...
                            <td class="handle">
                                ...
                                <br>
                                <small>
                                    Unit Price: ${product.product.unit_price} <br>
                                    Discount Price: ${product.product.discount_price || ''}
                                </small>
                            </td>
                            <td class="w-5">
    ...
    $('#new-in-products-table tbody').sortable({
        ...
        update: function (event, ui) {
            ...
            axios.post(`${base_url}/update-latest-offer-product-sorting`, {ids: sortedIds})
                .then(response => {
    ...
    function deleteSectionProduct(productId) {
            axios.delete(`${base_url}/delete-latest-offer-product`, {
